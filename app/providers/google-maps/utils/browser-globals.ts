...
export const WINDOW_GLOBAL = new OpaqueToken('denethiel-google-maps window_global');
export const DOCUMENT_GLOBAL = new OpaqueToken('denethiel-google-maps document_global');
